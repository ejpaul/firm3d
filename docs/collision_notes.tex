...
\begin{equation}
  ...
  \label{eq:vbar}
\end{equation}
following the ASCOT5 convention \cite{hirvijoki2014,ascot5code}.
This interpolation covers two limits: fast EP against ions
($v\gg\vth[b]$, so $\bar{v}\approx v$) and slow EP against electrons
($v\ll\vth[e]$, so $\bar{v}\approx\vth[e]$).
