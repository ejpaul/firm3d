...
So the two answer different questions: this example and the CPU one give the
equilibrium's own confinement and cross-check the tracer against each other,
while the Cartesian example gives what a particular coil set does to it. See
gpu_cartesian_collisional_tracing/README.txt for the numbers behind that.
