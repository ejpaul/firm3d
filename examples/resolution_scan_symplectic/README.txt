...
A resolution scan is performed in the number of gridpoints in the field interpolant and the stepsize. 
...
With resolution = 64 and dt = 1e-10, we see the relative error converge to ~1e-11. 

On perlmutter (12.04.25), the wallclock time is about 15 minutes using the attached slurm script. 